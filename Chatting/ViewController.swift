...
//  Chatting
//
//  Created by Boban Davidovic on 12/9/15.
...
class ViewController: JSQMessagesViewController {
    ...
    override func viewDidLoad() {
        ...
        let profileImageUrl = "img.png" as? NSString
    ...
    func receiveMessage()
    {
        let text = "text demo" as? String
        let sender = "sender demo" as? String
        let imageUrl = "img.png" as? String
    ...
    func sendMessage(text: String!, sender: String!) {
        ...
        print("img %s", self.senderImageUrl)
    }
    ...
    func setupAvatarColor(name: String, incoming: Bool) {
        let diameter =
            incoming ? UInt(collectionView!.collectionViewLayout.incomingAvatarViewSize.width) : UInt(collectionView!.collectionViewLayout.outgoingAvatarViewSize.width)
